...
public class TugWarCharRenderer : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Find and store the TugWarGameplayManager reference
        gameplayManager = FindObjectOfType<TugWarGameplayManager>();
        if (gameplayManager == null)
        {
            Debug.LogWarning("TugWarGameplayManager not found in the scene.");
        }
    }
